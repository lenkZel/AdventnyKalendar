...
public class GrafickaUprava {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            JFrame okno = new JFrame();  // Vytvorenie hlavného okna
            ...
            LocalDate aktualnyDatum = LocalDate.now();  // Nastavenie aktuálneho dátumu
            ...
            for (int den = 1; den <= 24; den++) {
                ...
                JButton tlacidlo = new JButton(String.valueOf(den));  // Vytvorenie tlacidla (okna)
                tlacidlo.setEnabled(otvoreneOkno.get(den - 1));
                tlacidlo.setBackground(new Color(153,204,255));
                int finalDen = den;
